    ...
    <table class="wpacu-form-table">
        ...
        <tr valign="top">
            ...
            <td>
                <label class="wpacu_switch
                    <?php if ( ! empty($data['is_optimize_js_enabled_by_other_party']) ) { echo 'wpacu_disabled'; } ?>">
                ...
                // [wpacu_pro]
                if ($data['inline_js_files'] == 1 && empty($data['is_optimize_css_enabled_by_other_party'])) {
                    $inlineJsFilesTagStyle = 'opacity: 1;';
                }
                // [/wpacu_pro]
                ?>
        ...
        <tr valign="top">
            ...
            <td>
                ...
                // [wpacu_pro]
                if ($data['move_scripts_to_body'] == 1) {
                    $moveScriptsToBodyStyle = 'opacity: 1;';
                }
                // [/wpacu_pro]
	            ?>
